...
const txt_PointHistoryPageTitle = browser.isAndroid ? `android=new UiSelector().descriptionContains("page-title")` : `-ios predicate string: name CONTAINS 'page-title'`
...
const txt_ChallengePoint = browser.isAndroid ? `android=new UiSelector().descriptionContains("my-points-history-confirmed-number")` : `-ios predicate string: name CONTAINS 'my-points-history-confirmed-number'`
const txt_ChallengeDate = browser.isAndroid ? `android=new UiSelector().descriptionContains("my-points-history-date")` : `-ios predicate string: name CONTAINS 'my-points-history-date'`
const txt_ChallengeName = browser.isAndroid ? `android=new UiSelector().descriptionContains("my-points-history-confirmed-name")` : `-ios predicate string: name CONTAINS 'my-points-history-confirmed-name'`
