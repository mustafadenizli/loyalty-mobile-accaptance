...
const btn_LandingButton = browser.isAndroid ? `android=new UiSelector().className("android.widget.Button")` : `-ios predicate string: name CONTAINS "My Modanisa'ya Katıl" || name CONTAINS "Giriş Yap"`
const area_TabBars = browser.isAndroid ? `android=new UiSelector().descriptionContains("tab-bar")` : `//XCUIElementTypeApplication[@name="Modanisa.α"]/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther[2]/XCUIElementTypeOther[2]/XCUIElementTypeOther[2]/XCUIElementTypeOther[2]/XCUIElementTypeOther[2]/XCUIElementTypeOther[2]/XCUIElementTypeOther[2]/XCUIElementTypeOther[3]/XCUIElementTypeOther[3]/XCUIElementTypeOther[2]`
const btn_TabBar = browser.isAndroid ? `android=new UiSelector().className("android.view.View")` : `-ios predicate string: name CONTAINS '-tab'`
