...
const txt_EnrollButton = browser.isAndroid ? `android=new UiSelector().descriptionContains("Kayıt Ol")` :  `-ios predicate string: name CONTAINS 'enrollment-form-page-complete-enrollment-button'`
