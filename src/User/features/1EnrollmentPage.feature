Feature: Navigate To Customer Loyalty Page
  ...
  | normal    | userLoyaltyLanding@modanisa.com   | Modanisa1234.  | 12727253    |
  | normal    | userLoyaltyDashboard@modanisa.com | Modanisa1234.  | 12727272    |
  | normal    | userloyaltyEnroll@yandex.com      | Modanisa1234.  | 12727273    |
  | facebook  | userloyaltyEnroll1@modanisa.com   | Modanisa1234.  | 12727275    |
  ...
  Scenario Outline: Nisa taps Kullanım Koşulları
    ...
    Examples:
      | user   | email                           | password      | customerId |
      | normal | userLoyaltyLanding@modanisa.com | Modanisa1234. | 12727273   |
